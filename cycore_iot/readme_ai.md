...
- Outbound message ids use a random per-boot id plus a monotonic counter, so flashing or resetting a board cannot collide with persistent server-side deduplication.
